...
TASK_ITEM(proc_subtask4,  subtask4_id, 5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_subtask5,  subtask5_id, 5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_subtask6,  subtask6_id, 5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_subtask7,  subtask7_id, 5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
TASK_ITEM(proc_subtask8,  subtask8_id, 5*1024, DEFAULT_VALUE1, DEFAULT_VALUE2)
#endif
